  ...
  <div class="app-container">
    <el-tabs class="back-f" v-model="activeName" type="border-card" @tab-click="handleClick">
      ...
      <el-tab-pane name="fifth">
        ...
        <ThreatsAnalysis :activeName="activeName" v-if="activeName==='fifth'"/>
      </el-tab-pane>
      ...
      <el-tab-pane name="seventh">
        ...
        <SecurityGoal :activeName="activeName" v-if="activeName==='seventh'"/>
      </el-tab-pane>
      <el-tab-pane name="eighth">
        <template slot="label">
          <div>Requirement allocation<br><small>网络安全需求分配</small></div>
        </template>
        <RequirementAllocation :activeName="activeName" v-if="activeName==='eighth'"/>
      </el-tab-pane>
      <el-tab-pane name="ninth">
        <template slot="label">
          <div>Concept allocation<br><small>网络安全概念分配</small></div>
        </template>
        <ConceptAllocation :activeName="activeName" v-if="activeName==='ninth'"/>
      </el-tab-pane>
      <el-tab-pane name="tenth">
        <template slot="label">
          <div>Risk Re-Assessment<br><small>风险重估</small></div>
        </template>
        <RiskReAssessment :activeName="activeName" v-if="activeName==='tenth'"/>
      </el-tab-pane>
      <el-tab-pane name="eleventh">
        <template slot="label">
          <div>Security Claim<br><small>安全声明</small></div>
        </template>
        <SecurityClaim :activeName="activeName" v-if="activeName==='eleventh'"/>
      </el-tab-pane>
      <el-tab-pane name="twelfth">
        <template slot="label">
          <div>Specification<br><small>安全规范</small></div>
        </template>
        <SecurityClaim :activeName="activeName" v-if="activeName==='twelfth'"/>
      </el-tab-pane>
      <el-tab-pane name="thirteenth">
        <template slot="label">
          <div>Integration Verification<br><small>集成规则</small></div>
        </template>
        <SecurityClaim :activeName="activeName" v-if="activeName==='thirteenth'"/>
      </el-tab-pane>
      <el-tab-pane name="fourteenth">
        <template slot="label">
          <div>Validation<br><small>安全验证</small></div>
        </template>
        <SecurityClaim :activeName="activeName" v-if="activeName==='fourteenth'"/>
      </el-tab-pane>
      <el-tab-pane name="fifteenth">
        <template slot="label">
          <div>TBD<br><small>待定</small></div>
        </template>
        <SecurityClaim :activeName="activeName" v-if="activeName==='fifteenth'"/>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
